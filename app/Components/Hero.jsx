...
export default function Hero() {
  return (
    <div style={{
        ...
        <div className='absolute left-4 md:left-8 lg:left-20 xl:left-28 2xl:left-40 bottom-40 lg:bottom-32 xl:bottom-36 font-extrabold text-black md:text-lg leading-6 tracking-tight'>
        ...
        <div className="absolute left-1/2 bottom-20 lg:bottom-12 w-1/2 flex justify-between items-center lg:pr-28 flex-col lg:flex-row gap-4 lg:gap-0">
            ...
            <div className="-translate-x-[25%] lg:-translate-x-0 flex items-center gap-4">
                <motion.div variants={fadeIn('right', 0)} initial='initial' whileInView={'show'} className='w-36 h-[6px] bg-amber-800 rounded-md cursor-pointer'></motion.div>
                <motion.div variants={fadeIn('left', 0)} initial='initial' whileInView={'show'} className='w-36 h-1 bg-white/30 rounded-md cursor-pointer'></motion.div>
            </div>
        </div>
    </div>
  )
